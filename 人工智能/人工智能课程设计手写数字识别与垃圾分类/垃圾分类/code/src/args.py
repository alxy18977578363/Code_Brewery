...
def train_parse_args():
   ...
   train_parser.add_argument('--dataset_path', type=str, default="../mobilenetv2/data_en/train", help='Dataset path')
   train_parser.add_argument('--pretrain_ckpt', type=str, default="../mobilenetv2/pretrain_checkpoint/mobilenetv2_cpu_gpu.ckpt", help='Pretrained checkpoint path \
...
def eval_parse_args():
    ...
    eval_parser.add_argument('--platform', type=str, default="CPU", choices=("Ascend", "GPU", "CPU"), \
        help='run platform, only support GPU, CPU and Ascend')
    eval_parser.add_argument('--dataset_path', type=str, default="../mobilenetv2/data_en/test", help='Dataset path')
    eval_parser.add_argument('--pretrain_ckpt', type=str, default="../mobilenetv2/pretrain_checkpoint/mobilenetv2_cpu_gpu.ckpt", help='Pretrained checkpoint path \
        for fine tune or incremental learning')
