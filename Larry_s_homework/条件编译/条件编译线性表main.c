...
int main()
{
    ...
    /* 要求插入元素，检测ListInsect1 */
#ifdef ELEMTYPE_IS_DOUBLE
    printf("\n下面检查ListInsect1,请输入要插入元素的值：\n");
    scanf("%lf", &e1);
#elif defined (ELEMTYPE_IS_CHAR_ARRAY) || defined (ELEMTYPE_IS_CHAR_P)
    printf("\n下面检查ListInsect1,请输入要插入元素的值：\n");
    scanf("%s", e1);
#elif defined (ELEMTYPE_IS_STRUCT_STUDENT)
    printf("\n下面检查ListInsect1,请输入要插入元素的值(学号 姓名 性别 成绩 地址)：\n");
    scanf("%d %s %c %f %s", &e1.num, e1.name, &e1.sex, &e1.score, e1.addr);
#elif defined (ELEMTYPE_IS_STRUCT_STUDENT_P)
    printf("\n下面检查ListInsect1,请输入要插入元素的值(学号 姓名 性别 成绩 地址)：\n");
    scanf("%d %s %c %f %s", &e1->num, e1->name, &e1->sex, &e1->score, e1->addr);
    ...
    scanf("%d", &e1);
       ...
       /* 要求用户输入一个被插的元素值 */
#ifdef ELEMTYPE_IS_DOUBLE
    printf("\n请输入一个表中元素值，你将插入到该元素前：\n");
    scanf("%lf", &e2);
#elif defined (ELEMTYPE_IS_CHAR_ARRAY) || defined (ELEMTYPE_IS_CHAR_P)
    printf("\n请输入一个表中元素值，你将插入到该元素前：\n");
    scanf("%s", e2);
#elif defined (ELEMTYPE_IS_STRUCT_STUDENT)
    printf("\n请输入表中的一个学号，你将插入到该元素前：\n");
    scanf("%d", &e2.num);
#elif defined (ELEMTYPE_IS_STRUCT_STUDENT_P)
    printf("\n请输入表中的一个学号，你将插入到该元素前：\n");
    scanf("%d", &e2->num);
    ...
    if (ListInsert1(&L,e2,e1,MyCompare) == OK)              // 这里说明插入成功
    {
#ifdef ELEMTYPE_IS_DOUBLE
    ...
    /* 要求用户输入一个被插的元素值 */
#ifdef ELEMTYPE_IS_DOUBLE
    printf("\n下面检查Listdelete1,请输入要删除元素的值：\n");
    scanf("%lf", &e1);
#elif defined (ELEMTYPE_IS_CHAR_ARRAY) || defined (ELEMTYPE_IS_CHAR_P)
    printf("\n下面检查Listdelete1,请输入要删除元素的值：\n");
    scanf("%s", e1);
#elif defined (ELEMTYPE_IS_STRUCT_STUDENT)
    printf("\n下面检查Listdelete1,请输入要删除元素学号：\n");
    scanf("%d", &e1.num);
#elif defined (ELEMTYPE_IS_STRUCT_STUDENT_P)
    printf("\n下面检查Listdelete1,请输入要删除元素学号：\n");
    scanf("%d", &e1->num);
    ...
    /* 要求插入元素，检测ListInsect1 */
#ifdef ELEMTYPE_IS_DOUBLE
    printf("\n下面检查Listdelete2,请输入要重复插入元素的值：\n");
    scanf("%lf", &e1);
#elif defined (ELEMTYPE_IS_CHAR_ARRAY) || defined (ELEMTYPE_IS_CHAR_P)
    printf("\n下面检查Listdelete2,请输入要重复插入元素的值：\n");
    scanf("%s", e1);
#elif defined (ELEMTYPE_IS_STRUCT_STUDENT)
    printf("\n下面检查Listdelete2,请输入要重复插入元素的值(学号 姓名 性别 成绩 地址)：\n");
    scanf("%d %s %c %f %s", &e1.num, e1.name, &e1.sex, &e1.score, e1.addr);
#elif defined (ELEMTYPE_IS_STRUCT_STUDENT_P)
    printf("\n下面检查Listdelete2,请输入要重复插入元素的值(学号 姓名 性别 成绩 地址)：\n");
    scanf("%d %s %c %f %s", &e1->num, e1->name, &e1->sex, &e1->score, e1->addr);
