...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "on_importTextButton_clicked",
        "on_exportTableButton_clicked",
        "on_exportPhotoButton_clicked",
        "on_keyWordTable_itemActivated",
        "QTableWidgetItem*",
        "item",
        "on_addButton_clicked",
        "on_deleteButton_clicked",
        "on_randomComboBox_activated",
        "index"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_ensureButton_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_textInput_textChanged'
        QtMocHelpers::SlotData<void(const QString &)>(3, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::QString, 4 },
        }}),
        // Slot 'on_clearButton_clicked'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_importTextButton_clicked'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_exportTableButton_clicked'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_exportPhotoButton_clicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_keyWordTable_itemActivated'
        ...
        // Slot 'on_randomComboBox_activated'
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_ensureButton_clicked(); break;
        case 1: _t->on_textInput_textChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->on_clearButton_clicked(); break;
        case 3: _t->on_importTextButton_clicked(); break;
        case 4: _t->on_exportTableButton_clicked(); break;
        case 5: _t->on_exportPhotoButton_clicked(); break;
        case 6: _t->on_keyWordTable_itemActivated((*reinterpret_cast< std::add_pointer_t<QTableWidgetItem*>>(_a[1]))); break;
        case 7: _t->on_addButton_clicked(); break;
        case 8: _t->on_deleteButton_clicked(); break;
        case 9: _t->on_randomComboBox_activated((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
    }
}
